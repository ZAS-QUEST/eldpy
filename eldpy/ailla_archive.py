...
class AillaArchive:
    ...
    def insert_into_database(self, db_name='test.db'):
        ...
        found_ids = {}
        with open("ailla_copy_f.json") as json_in:
            d = json.load(json_in)
        for collection_name, collection_d in d.items():
            ...
            for bundle_name, bundle_d in collection_d['bundles'].items():
                ...
                for f in bundle_d['files']:
                    ...
                    if found_ids.get(id_):
                        ...
                        continue
                    found_ids[id_] = 1
                    insert_file_tuple = (id_, "AILLA", collection_name, bundle_name, type_, type_,size,length)
        ...
        # pprint.pprint(insert_file_list[:10])
        ...
        # pprint.pprint(insert_language_list[:10])
        connection.commit()
        connection.close()
