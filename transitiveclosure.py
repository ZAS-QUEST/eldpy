...
def process(branch):
    #the branch contains the leaves on the right. As we progress towards the root, we add nodes to the left
    ego = branch[0]
...
if __name__ == "__main__":
    knownloops = ['Q141488', 'Q11348', 'Q2642629'] #function, graph, multigraph loop back to themselves in their line of descendency.
    #read the input file
